...
const DATABASE_URL = process.env.DATABASE_URL ||
  `postgresql://wheeler:${DB_PASSWORD}@${COREDB_TAILSCALE}:5432/wheeler_core`;

const REDIS_URL = process.env.REDIS_URL ||
  (REDIS_PASSWORD
    ? `redis://:${REDIS_PASSWORD}@${COREDB_TAILSCALE}:6379`
    : `redis://${COREDB_TAILSCALE}:6379`);
  ...
  apps: [
    ...
    //     OPTIMIZED: memory cap reduced 2G→1G, log path standardized
    {
      ...
      env: {
        ...
        LANGFUSE_HOST: process.env.LANGFUSE_HOST || "http://localhost:3020",
        LOG_LEVEL: "info",
        STRIPE_SECRET_KEY: process.env.STRIPE_SECRET_KEY || "",
        STRIPE_WEBHOOK_SECRET: process.env.STRIPE_WEBHOOK_SECRET || "",
        OUTREACH_KILL_SWITCH: process.env.OUTREACH_KILL_SWITCH || "false",
        OUTREACH_DRY_RUN: process.env.OUTREACH_DRY_RUN || "false",
      },
    },
    ...
    // ── 13. FRGCRM Agent Service (port 8003) ─────────────────────────────
    {
      ...
      env: {
        ...
        FRGCRM_INTERNAL_TOKEN: process.env.FRGCRM_INTERNAL_TOKEN || "",
        DATABASE_URL,
        REDIS_URL,
        LOG_LEVEL: "info",
      },
    ...
    // ── 14. Insforge Agent Service (port 8013) ───────────────────────────
    {
      ...
      env: {
        ...
        INSFORGE_BASE_URL: process.env.INSFORGE_BASE_URL || "http://100.98.163.17:7130",
        INSFORGE_API_KEY: process.env.INSFORGE_API_KEY || "",
        POSTGREST_URL: process.env.POSTGREST_URL || "http://100.98.163.17:5430",
        DATABASE_URL,
        REDIS_URL,
        LOG_LEVEL: "info",
      },
