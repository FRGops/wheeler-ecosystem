...
# ═══════════════════════════════════════════════════
TASK_SIZE="small"
if echo "$PROMPT" | grep -qiE '\b(tiny|minor|quick|single|one.line|one.file|typo|spelling)\b'; then
    TASK_SIZE="micro"
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🤖 WHEELER CODING OS — DYNAMIC INTELLIGENCE v2.0
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Task:         $TASK_TYPE | Size: $TASK_SIZE
Domains:      ${MATCHED_DOMAINS:-auto-detect}
Army Mode:    $ARMY_MODE | Pipeline: $PIPELINE_DEPTH
...
📋 PHASE RULES:
  ...
  - REVIEW agents: deploy ALL in PARALLEL (single message)
...
⚔️ ARMY MODE — MULTI-AGENT PARALLEL DEPLOYMENT
